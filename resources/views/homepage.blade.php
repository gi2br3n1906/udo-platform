        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10">
            <div class="text-center">
                ...
                <div class="text-xl sm:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed font-medium will-change-auto">
                    ...
                    <span class="text-yellow-400 font-semibold">{{ $universityCount ?? 15 }} universitas terbaik</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
                    <div class="bg-white/10 border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-colors duration-200">
                        <div class="text-4xl font-black text-yellow-400 mb-2">{{ $universityCount ?? 15 }}</div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="group relative bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-lg border border-blue-500/20 rounded-3xl p-8 hover:from-blue-500/20 hover:to-cyan-500/20 transition-all duration-500 hover:scale-105">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-gray-300 leading-relaxed">Jelajahi <span class="text-cyan-400 font-bold">{{ $universityCount ?? 15 }} universitas terbaik</span> dari PTN, PTS, dan perguruan tinggi kedinasan di Indonesia! 🎓</p>
                    </div>
                </div>
        ...
        <div class="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <button onclick="accessFeature('universities')"
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Jelajahi {{ $universityCount ?? 15 }} universitas terbaik yang berpartisipasi</p>
        ...
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center">
                <p class="text-gray-400 text-sm">
                    © {{ date('Y') }} UDO Platform. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
        ...
        <div class="flex items-center justify-center min-h-screen p-4 py-8">
            <div id="modalContent" class="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 relative shadow-2xl transform transition-all duration-300 my-4 max-h-[90vh] overflow-y-auto">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">Untuk pengalaman terbaik dalam menjelajahi <strong>{{ $universityCount ?? 15 }} universitas</strong> pilihan, mohon perkenalkan diri Anda terlebih dahulu 😊</p>
                </div>

                <form id="registrationForm" action="{{ route('visitor.store') }}" method="POST" class="space-y-4">
                    @csrf
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @if(session('show_popup') && session('redirect_to'))
                console.log('Session flash data detected - showing popup');
                setTimeout(() => {
                    showRegistrationModal('{{ session("redirect_to") }}');
                }, 500);
            @elseif(isset($_GET['show_popup']) && $_GET['show_popup'] == '1')
                console.log('URL parameter detected - showing popup');
                setTimeout(() => {
                    showRegistrationModal('{{ $_GET["redirect_to"] ?? "universities" }}');
                }, 500);
            @endif
        });
