        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div class="bg-gradient-to-r from-emerald-500 to-blue-500 rounded-xl p-6 text-white shadow-2xl border border-white/20">
                        <div class="flex items-start space-x-3 mb-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <h2 class="text-xl font-semibold mb-1 critical-content">
                                    Selamat Datang, <?php echo e($visitor->full_name); ?>!
                                </h2>
                                <p class="text-blue-100 text-sm">
                                    Temukan universitas impianmu dari <?php echo e($universities->count()); ?> pilihan universitas terbaik
                                </p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                            <div class="bg-white/20 backdrop-blur-lg rounded-xl p-4 text-center border border-white/30 hover:bg-white/30 transition-all duration-300">
                                <div class="text-2xl font-bold text-yellow-400"><?php echo e($universities->count()); ?></div>
                                <div class="text-sm text-white">Universitas</div>
                            </div>
                            <?php if($visitor->favoriteUniversities->count() > 0): ?>
                            <div class="bg-white/20 backdrop-blur-lg rounded-xl p-4 text-center border border-white/30 hover:bg-white/30 transition-all duration-300">
                                <div class="text-2xl font-bold text-pink-400"><?php echo e($visitor->favoriteUniversities->count()); ?></div>
                                <div class="text-sm text-white">Favorit</div>
                            </div>
                            <?php endif; ?>
                            <div class="bg-white/20 backdrop-blur-lg rounded-xl p-4 text-center border border-white/30 hover:bg-white/30 transition-all duration-300">
                                <div class="text-2xl font-bold text-emerald-400"><?php echo e($universities->where('type', 'PTN')->count()); ?></div>
                                <div class="text-sm text-white">PTN</div>
                            </div>
                            <div class="bg-white/20 backdrop-blur-lg rounded-xl p-4 text-center border border-white/30 hover:bg-white/30 transition-all duration-300">
                                <div class="text-2xl font-bold text-purple-400"><?php echo e($universities->where('type', 'PTS')->count()); ?></div>
                    ...
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 shadow-2xl">
                        <div class="text-center">
                            ...
                            <p class="text-gray-300 text-lg">
                                Temukan universitas terbaik yang sesuai dengan minat dan bakatmu dari <span class="text-yellow-400 font-semibold"><?php echo e($universities->count()); ?> pilihan universitas</span>
                            </p>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <?php if(session('success')): ?>
                <div class="mb-8 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-6 shadow-lg">
                    <div class="flex items-center">
                        ...
                        <p class="text-white font-semibold text-lg"><?php echo e(session('success')); ?></p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="search-filter-container mb-8 space-y-6">
                ...
                <div class="flex flex-wrap gap-3 justify-center">
                    <button id="filterAll" class="filter-btn active px-6 py-3 text-lg font-semibold rounded-2xl bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                        Semua (<?php echo e($universities->count()); ?>)
                    </button>
                    <button id="filterPTN" class="filter-btn px-6 py-3 text-lg font-semibold rounded-2xl bg-white/10 backdrop-blur-lg text-white border border-white/20 shadow-xl hover:bg-gradient-to-r hover:from-emerald-500 hover:to-green-500 hover:text-white transform hover:scale-105 transition-all duration-300">
                        PTN (<?php echo e($universities->where('type', 'PTN')->count()); ?>)
                    </button>
                    <button id="filterPTS" class="filter-btn px-6 py-3 text-lg font-semibold rounded-2xl bg-white/10 backdrop-blur-lg text-white border border-white/20 shadow-xl hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 hover:text-white transform hover:scale-105 transition-all duration-300">
                        PTS (<?php echo e($universities->where('type', 'PTS')->count()); ?>)
                    </button>
                    <button id="filterSaintek" class="filter-btn px-6 py-3 text-lg font-semibold rounded-2xl bg-white/10 backdrop-blur-lg text-white border border-white/20 shadow-xl hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 hover:text-white transform hover:scale-105 transition-all duration-300">
                        Saintek (<?php echo e($universities->where('category', 'Saintek')->count()); ?>)
                    </button>
                    <button id="filterSoshum" class="filter-btn px-6 py-3 text-lg font-semibold rounded-2xl bg-white/10 backdrop-blur-lg text-white border border-white/20 shadow-xl hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-500 hover:text-white transform hover:scale-105 transition-all duration-300">
                        Soshum (<?php echo e($universities->where('category', 'Soshum')->count()); ?>)
                    </button>
                </div>
            </div>
            ...
            <div id="mapView" class="mb-6">
                <div class="loading-placeholder" style="min-height: 400px;">
                    <?php if (isset($component)) { $__componentOriginal5f9d4b22eb32f217c0393f220bd5180a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5f9d4b22eb32f217c0393f220bd5180a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.expo-floor-plan','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('expo-floor-plan'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal5f9d4b22eb32f217c0393f220bd5180a)): ?>
<?php $attributes = $__attributesOriginal5f9d4b22eb32f217c0393f220bd5180a; ?>
<?php unset($__attributesOriginal5f9d4b22eb32f217c0393f220bd5180a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5f9d4b22eb32f217c0393f220bd5180a)): ?>
<?php $component = $__componentOriginal5f9d4b22eb32f217c0393f220bd5180a; ?>
<?php unset($__componentOriginal5f9d4b22eb32f217c0393f220bd5180a); ?>
<?php endif; ?>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <?php $__currentLoopData = $universities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $university): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-xl hover:shadow-2xl hover:bg-white/20 transition-all duration-300 group transform hover:scale-105">
                            <a href="<?php echo e(route('universities.show', $university->slug)); ?>" class="block">
                                <!-- University Logo -->
                                <div class="aspect-square w-full bg-white/10 backdrop-blur-lg rounded-t-2xl flex items-center justify-center p-6 border-b border-white/20">
                                    <?php if($university->logo_url): ?>
                                        <img src="<?php echo e($university->logo_url); ?>"
                                    ...
                                    <?php else: ?>
                                        <div class="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg">
                                            <span class="text-white text-2xl font-bold">
                                                <?php echo e(strtoupper(substr($university->name, 0, 1))); ?>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex flex-wrap gap-1 mb-3">
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                            <?php if($university->type === 'PTN'): ?> bg-green-100 text-green-800
                                            <?php elseif($university->type === 'PTS'): ?> bg-blue-100 text-blue-800
                                            <?php else: ?> bg-purple-100 text-purple-800 <?php endif; ?>">
                                            <?php echo e($university->type); ?>

                                        </span>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                            <?php if($university->category === 'Saintek'): ?> bg-orange-100 text-orange-800
                                            <?php elseif($university->category === 'Soshum'): ?> bg-pink-100 text-pink-800
                                            <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                            <?php echo e($university->category); ?>
                                    ...
                                    <?php if($university->description): ?>
                                        <p class="text-gray-300 text-sm line-clamp-2 mb-4 leading-relaxed">
                                            <?php echo e(Str::limit($university->description, 80)); ?>

                                        </p>
                                    <?php endif; ?>

                                    <!-- Favorite Status -->
                                    <?php if($visitor && $visitor->hasFavorited($university)): ?>
    ...
    <script>
        ...
        let universitiesData = <?php echo json_encode($universities->keyBy('id'), 15, 512) ?>;
