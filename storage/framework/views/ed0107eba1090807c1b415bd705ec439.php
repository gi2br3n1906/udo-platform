...
<?php $component->withAttributes([]); ?>
    <?php $__env->startPush('title', $university->name . ' - UDO Platform'); ?>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-gradient-to-r from-purple-600/30 to-blue-600/30 backdrop-blur-lg px-8 py-8">
                        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                            <div class="flex flex-col sm:flex-row sm:items-center gap-6">
                                ...
                                <!-- University Info -->
                                <div>
                                    <h1 class="text-3xl font-bold text-white mb-3"><?php echo e($university->name); ?></h1>
                            ...
                            <div class="flex justify-start lg:justify-end">
                                <form method="POST" action="<?php echo e(route('universities.toggle-favorite', $university->slug)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="flex items-center px-6 py-3 rounded-xl font-medium transition-all duration-200 backdrop-blur-lg border
                                        ...
                                        <?php endif; ?>">
                                        <svg class="w-5 h-5 mr-2 <?php if($hasFavorited): ?> fill-current <?php else: ?> stroke-current <?php endif; ?>" viewBox="0 0 20 20">
                                            <path <?php if($hasFavorited): ?>
                                        ...
                                        <?php if($hasFavorited): ?> Hapus Favorit <?php else: ?> Tambah Favorit <?php endif; ?>
                                    </button>
                                </form>
                            </div>
                            <?php endif; ?>
                ...
                <?php if(session('success')): ?>
                    <div class="mb-8 bg-green-500/20 backdrop-blur-lg border border-green-400/30 rounded-xl p-4">
                        <div class="flex items-center">
                            ...
                            <p class="text-sm font-medium text-green-100"><?php echo e(session('success')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-xl">
                            ...
                            <div class="prose prose-lg max-w-none">
                                <p class="text-white/80 leading-relaxed text-lg"><?php echo e($university->description); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>

                        <!-- Social Media -->
                        <?php if($university->social_media && count($university->social_media) > 0): ?>
                        <div class="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-xl">
                            <h2 class="text-2xl font-semibold text-white mb-6 flex items-center">
                                <svg class="w-6 h-6 mr-3 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <?php $__currentLoopData = $university->social_media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($url): ?>
                                    <a href="<?php echo e($url); ?>" target="_blank"
                                       class="flex items-center p-4 rounded-xl bg-white/5 border border-white/10 hover:border-white/30 hover:bg-white/10 transition-all duration-200 group">
                                        <div class="w-12 h-12 rounded-lg bg-white/10 backdrop-blur-lg flex items-center justify-center mr-4 group-hover:bg-white/20">
                                            <?php if(strtolower($platform) === 'instagram'): ?>
                                            ...
                                            <?php elseif(strtolower($platform) === 'tiktok'): ?>
                                        ...
                                        <div>
                                            <p class="font-medium text-white capitalize"><?php echo e($platform); ?></p>
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-semibold text-white"><?php echo e($university->type); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-lg font-semibold text-white"><?php echo e($university->category); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Official Website -->
                        <?php if($university->official_link): ?>
                        <div class="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8 shadow-xl">
                            <h3 class="text-xl font-semibold text-white mb-6 flex items-center">
                                <svg class="w-6 h-6 mr-3 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="<?php echo e($university->official_link); ?>" target="_blank"
...
<?php endif; ?>
<?php /**PATH D:\Coding\UDO\udo-platform\resources\views/universities/show.blade.php ENDPATH**/ ?>